...
from verilogeval import stats_execute, get_prompts_with_ids, STOP_SEQUENCES
...
def main():
    ...
    for prompt, task_id in prompts_ids:
        ...
        num_iter += 1
        render_graphviz_tree(root, filename=f"svgviz/tree_{task_id.replace('/', '_')}", view=False)
